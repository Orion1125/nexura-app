...
>
              ...
              <div className="absolute top-0 right-0 bg-background/90 border border-border rounded px-1 py-0.5 text-[10px] sm:text-xs font-bold text-foreground z-10 hidden sm:block"
